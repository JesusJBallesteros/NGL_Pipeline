function rez2Phy(rez, savePath)
% Modified to add output of template_bestchannels.mat. By Winston and Sara.
% Original found in [Drive]\KiloSort2_SpikeSorting\Kilosort2-master\utils
%
% Pulls out results from kilosort's rez to either return to workspace or to
