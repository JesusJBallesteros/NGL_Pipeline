function highPassFilter500(numChannels,filePathSingleChannels,filePathSingleChannelsFilt,HDF5chunkSize,filterSettings)
...
for i = 1:numChannels 
    ...
    filteredData = filter(filterSettings,...
        double(... 
        h5read(...
