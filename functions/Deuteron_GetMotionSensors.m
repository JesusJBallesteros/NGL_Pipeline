...
% MS_Gyr = [data.gyr.X; data.gyr.Y; data.gyr.Z]';
MS_Mag = [data.magcorr.X; data.magcorr.Y; data.magcorr.Z]'; % corrected
...
rotators = ecompass(MS_Acc, MS_Mag);

%% Plot
% Run the plot function.
Deuteron_PlotMotionSensors(rotators, timestamps, opt, 3, 1, 1); % rotators data
