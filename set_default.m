...
if isfield(opt,'kilosort')
    ...
    elseif opt.kilosort == 4
       ...
       % % %input.KSpyenv_NGL = 'C:\Code\miniconda3\envs\kilosort\Lib\site-packages\kilosort'; %'C:\Users\ballejd4\AppData\Local\miniconda3\envs\kilosort'; % Kilosort enviroment under python installation. It could change among PCs
% % Added 15.08.2025 for testing ...
       input.KSpython = 'C:\Users\ACN\anaconda3\envs\kilosort\'; % where the desired python.exe version
        input.KSpyfolder = [input.KSpython,'\Lib\site-packages\kilosort']; % Path to the kilosort enviroment using that python version
% % ... till here
