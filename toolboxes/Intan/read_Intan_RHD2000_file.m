...
% read_Intan_RHD2000_file(varargin)
%
...
%
%INPUTS (OPTIONAL)
%  *path                : path of INTAN info file
%  *file                : name of INTAN info file (*.rhd)
%  *                    : if either file or path are missing the function
%                         opens a GUI for the user to select the file
% Example:
% read_Intan_RHD2000_file(filePath,fileName)
%
% Example:
% >> clear
...
%
% 11.10.2017, unkown: v2.0.1 inherited function
% 26.05.2021, Lukas : v2.1.0 updated function to handle optional filename 
%                            and path input, restructured documentation
%%
if numel(varargin)~=2
