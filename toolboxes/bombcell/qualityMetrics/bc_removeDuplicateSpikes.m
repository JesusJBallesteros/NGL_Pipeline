function [nonEmptyUnits, duplicateSpikes_idx, spikeTimes_samples, spikeTemplates, templateAmplitudes, ...
    ...
    pcFeatures, rawWaveformsFull, rawWaveformsPeakChan, signalToNoiseRatio, maxChannels, param, path)
...
% Config
removeDuplicateSpikes_flag  = param.removeDuplicateSpikes;
duplicateSpikeWindow_s      = param.duplicateSpikeWindow_s;
ephys_sample_rate           = param.ephys_sample_rate;
saveSpikes_withoutDuplicates_flag = param.saveSpikes_withoutDuplicates;
savePath                    = path.savePath;
recompute                   = param.recomputeDuplicateSpikes;
