function bc_plotGlobalQualityMetric(qMetric, param, unitType, uniqueTemplates, templateWaveforms, path)
% JF,
%
% Inputs
%
...
%     bc_upSetPlot(qMetric, param, qMetricNames, figHandle)
    ...
    saveas(gcf, fullfile(path.savePath, "waveforms_summary"), 'png');
    close(gcf);
    ...
    try
        ...
        prettify_plot('FigureColor', 'White')
    
        set(gcf,'Position',[100 100 900 600])
        saveas(gcf, fullfile(path.savePath, "qMetrics_summary"), 'png')
        close(gcf)
