function [percentMissing_gaussian, percentMissing_symmetric, ksTest_pValue, ampliBin_gaussian, spikeCountsPerAmpliBin_gaussian, gaussianFit_cutoff] = ...
    bc_percSpikesMissing(theseAmplitudes, theseSpikeTimes, timeChunks, param)
