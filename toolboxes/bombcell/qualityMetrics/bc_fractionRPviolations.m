function [fractionRPVs, nRPVs, overestimateBool] = bc_fractionRPviolations(theseSpikeTimes, theseAmplitudes, tauR, timeChunks, param)
% JF, get the estimated fraction of refractory period violation for a unit for each timeChunk
% Inputs
...
%    is too high. we then overestimate the fraction of contamination.
%
% Reference
...
if plotThis
    ...
    if exist('prettify_plot', 'file')
        prettify_plot('FigureColor', 'white', 'TickLength', 0.01)
    else
